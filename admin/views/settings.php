		...
		<div id="tab-ai-engine" class="aicb-tab-panel active">
			...
			<div class="aicb-section">
				...
				<div class="aicb-provider-grid" id="aicb-provider-grid">
					...
					foreach ( $providers as $pid => $pdata ) :
						...
						?>
						<label class="aicb-provider-card<?php echo $sel; ?>" data-provider="<?php echo esc_attr( $pid ); ?>">
							<input type="radio" name="aicb_provider" value="<?php echo esc_attr( $pid ); ?>"<?php echo checked( $cur_provider, $pid, false ); ?>>
							<span class="aicb-provider-logo"><?php echo $logos[ $pid ] ?? '🤖'; ?></span>
							<span class="aicb-provider-name"><?php echo esc_html( $pdata['name'] ); ?></span>
						</label>
					<?php endforeach; ?>
				</div>
				...
				<table class="form-table" style="margin-top:0">
					...
					foreach ( $providers as $pid => $pdata ) :
						...
						?>
						<tr class="aicb-key-row<?php echo $active; ?>" id="aicb-keyrow-<?php echo esc_attr( $pid ); ?>">
							<th style="width:200px">
								<label for="aicb_key_<?php echo esc_attr( $pid ); ?>"><?php echo esc_html( $pdata['key_label'] ); ?></label>
							</th>
							<td>
								<input type="password" id="aicb_key_<?php echo esc_attr( $pid ); ?>"
								name="aicb_key_<?php echo esc_attr( $pid ); ?>"
								value="<?php echo esc_attr( $display_val ); ?>"
								class="regular-text" autocomplete="new-password"
								placeholder="<?php echo esc_attr( $placeholder ); ?>"<?php echo $disabled; ?> />
								<?php if ( $has_const ) : ?>
								...
								<?php elseif ( ! empty( $pdata['key_help'] ) ) : ?>
									<p class="description"><?php echo esc_html( $pdata['key_help'] ); ?>
									<?php if ( ! empty( $pdata['docs_url'] ) ) : ?>
										— <a href="<?php echo esc_url( $pdata['docs_url'] ); ?>" target="_blank" rel="noopener"><?php esc_html_e( 'Docs ↗', 'ai-chatbot' ); ?></a>
									<?php endif; ?>
								</p>
							<?php endif; ?>
						</td>
			...
			<div class="aicb-section">
				...
				<table class="form-table">
					<tr>
						...
						<td>
							<select id="aicb_chatbot_language_mode" name="aicb_chatbot_language_mode">
								<option value="auto" <?php echo selected( aicb_opt( 'chatbot_language_mode' ), 'auto', false ); ?>><?php esc_html_e( 'Auto-detect (visitor browser language)', 'ai-chatbot' ); ?></option>
								<option value="fixed" <?php echo selected( aicb_opt( 'chatbot_language_mode' ), 'fixed', false ); ?>><?php esc_html_e( 'Fixed language (choose below)', 'ai-chatbot' ); ?></option>
							</select>
					...
					<tr id="aicb-fixed-language-row" style="<?php echo aicb_opt( 'chatbot_language_mode' ) === 'fixed' ? '' : 'display:none'; ?>">
						...
						<td>
							<select id="aicb_chatbot_language" name="aicb_chatbot_language">
								...
								<option value="English" <?php echo selected( aicb_opt( 'chatbot_language' ), 'English', false ); ?>><?php esc_html_e( 'English', 'ai-chatbot' ); ?></option>
								<option value="Español" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Español', false ); ?>><?php esc_html_e( 'Español', 'ai-chatbot' ); ?></option>
								<option value="Français" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Français', false ); ?>><?php esc_html_e( 'Français', 'ai-chatbot' ); ?></option>
								<option value="Deutsch" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Deutsch', false ); ?>><?php esc_html_e( 'Deutsch', 'ai-chatbot' ); ?></option>
								<option value="Português" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Português', false ); ?>><?php esc_html_e( 'Português', 'ai-chatbot' ); ?></option>
								<option value="Italiano" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Italiano', false ); ?>><?php esc_html_e( 'Italiano', 'ai-chatbot' ); ?></option>
								<option value="Nederlands" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Nederlands', false ); ?>><?php esc_html_e( 'Nederlands', 'ai-chatbot' ); ?></option>
								<option value="日本語" <?php echo selected( aicb_opt( 'chatbot_language' ), '日本語', false ); ?>><?php esc_html_e( '日本語', 'ai-chatbot' ); ?></option>
								<option value="中文 (简体)" <?php echo selected( aicb_opt( 'chatbot_language' ), '中文 (简体)', false ); ?>><?php esc_html_e( '中文 (简体)', 'ai-chatbot' ); ?></option>
								<option value="中文 (繁體)" <?php echo selected( aicb_opt( 'chatbot_language' ), '中文 (繁體)', false ); ?>><?php esc_html_e( '中文 (繁體)', 'ai-chatbot' ); ?></option>
								<option value="한국어" <?php echo selected( aicb_opt( 'chatbot_language' ), '한국어', false ); ?>><?php esc_html_e( '한국어', 'ai-chatbot' ); ?></option>
								<option value="Русский" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Русский', false ); ?>><?php esc_html_e( 'Русский', 'ai-chatbot' ); ?></option>
								<option value="العربية" <?php echo selected( aicb_opt( 'chatbot_language' ), 'العربية', false ); ?>><?php esc_html_e( 'العربية', 'ai-chatbot' ); ?></option>
								<option value="हिन्दी" <?php echo selected( aicb_opt( 'chatbot_language' ), 'हिन्दी', false ); ?>><?php esc_html_e( 'हिन्दी', 'ai-chatbot' ); ?></option>
								<option value="Bahasa Indonesia" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Bahasa Indonesia', false ); ?>><?php esc_html_e( 'Bahasa Indonesia', 'ai-chatbot' ); ?></option>
								<option value="Türkçe" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Türkçe', false ); ?>><?php esc_html_e( 'Türkçe', 'ai-chatbot' ); ?></option>
								<option value="Polski" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Polski', false ); ?>><?php esc_html_e( 'Polski', 'ai-chatbot' ); ?></option>
								<option value="Svenska" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Svenska', false ); ?>><?php esc_html_e( 'Svenska', 'ai-chatbot' ); ?></option>
								<option value="Dansk" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Dansk', false ); ?>><?php esc_html_e( 'Dansk', 'ai-chatbot' ); ?></option>
								<option value="Suomi" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Suomi', false ); ?>><?php esc_html_e( 'Suomi', 'ai-chatbot' ); ?></option>
								<option value="Norsk" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Norsk', false ); ?>><?php esc_html_e( 'Norsk', 'ai-chatbot' ); ?></option>
								<option value="Čeština" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Čeština', false ); ?>><?php esc_html_e( 'Čeština', 'ai-chatbot' ); ?></option>
								<option value="Română" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Română', false ); ?>><?php esc_html_e( 'Română', 'ai-chatbot' ); ?></option>
								<option value="Magyar" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Magyar', false ); ?>><?php esc_html_e( 'Magyar', 'ai-chatbot' ); ?></option>
								<option value="Ελληνικά" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Ελληνικά', false ); ?>><?php esc_html_e( 'Ελληνικά', 'ai-chatbot' ); ?></option>
								<option value="Tiếng Việt" <?php echo selected( aicb_opt( 'chatbot_language' ), 'Tiếng Việt', false ); ?>><?php esc_html_e( 'Tiếng Việt', 'ai-chatbot' ); ?></option>
								<option value="ไทย" <?php echo selected( aicb_opt( 'chatbot_language' ), 'ไทย', false ); ?>><?php esc_html_e( 'ไทย', 'ai-chatbot' ); ?></option>
								<option value="עברית" <?php echo selected( aicb_opt( 'chatbot_language' ), 'עברית', false ); ?>><?php esc_html_e( 'עברית', 'ai-chatbot' ); ?></option>
							</select>
			...
			<div class="aicb-section">
				...
				<table class="form-table">
					<tr>
						...
						<td>
							<label>
								<input type="checkbox" name="aicb_enable_cache" value="1" <?php echo checked( aicb_opt( 'enable_cache' ), 1 ); ?> />
					...
					<tr>
						...
						<td>
							<select id="aicb_cache_duration" name="aicb_cache_duration">
								<option value="0"    <?php echo selected( aicb_opt( 'cache_duration' ), 0, false ); ?>><?php esc_html_e( 'Until Content Changes (Infinite)', 'ai-chatbot' ); ?></option>
								<option value="720"  <?php echo selected( aicb_opt( 'cache_duration' ), 720, false ); ?>><?php esc_html_e( '30 Days', 'ai-chatbot' ); ?></option>
								<option value="168"  <?php echo selected( aicb_opt( 'cache_duration' ), 168, false ); ?>><?php esc_html_e( '7 Days', 'ai-chatbot' ); ?></option>
								<option value="24"   <?php echo selected( aicb_opt( 'cache_duration' ), 24, false ); ?>><?php esc_html_e( '24 Hours', 'ai-chatbot' ); ?></option>
								<option value="1"    <?php echo selected( aicb_opt( 'cache_duration' ), 1, false ); ?>><?php esc_html_e( '1 Hour', 'ai-chatbot' ); ?></option>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td>
							<label style="display:block;margin-bottom:6px">
								<input type="radio" name="aicb_indexing_mode" value="opt-out" <?php echo checked( aicb_opt( 'indexing_mode' ), 'opt-out' ); ?> />
							...
							<label style="display:block">
								<input type="radio" name="aicb_indexing_mode" value="opt-in" <?php echo checked( aicb_opt( 'indexing_mode' ), 'opt-in' ); ?> />
						...
						<td>
							...
							foreach ( $post_types as $type ) :
								...
								<label style="display:inline-block;margin-right:16px">
									<input type="checkbox" name="aicb_indexed_post_types[]" value="<?php echo esc_attr( $type->name ); ?>" <?php echo $checked; ?> />
					...
					<tr>
						...
						<td>
							<input type="text" id="aicb_business_name" name="aicb_business_name" 
									value="<?php echo esc_attr( aicb_opt( 'business_name' ) ); ?>" class="regular-text" 
					...
					<tr>
						...
						<td>
							<select id="aicb_pronoun_perspective" name="aicb_pronoun_perspective">
								<option value="first-plural"   <?php echo selected( aicb_opt( 'pronoun_perspective' ), 'first-plural', false ); ?>><?php esc_html_e( 'First-Person Plural (We / Our / Us) — For Teams & Agencies', 'ai-chatbot' ); ?></option>
								<option value="first-singular" <?php echo selected( aicb_opt( 'pronoun_perspective' ), 'first-singular', false ); ?>><?php esc_html_e( 'First-Person Singular (I / My / Me) — For Solo Freelancers', 'ai-chatbot' ); ?></option>
								<option value="neutral"        <?php echo selected( aicb_opt( 'pronoun_perspective' ), 'neutral', false ); ?>><?php esc_html_e( 'Neutral Third-Person (The Company / The Service)', 'ai-chatbot' ); ?></option>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td>
							<select id="aicb_chatbot_tone" name="aicb_chatbot_tone">
								<option value="casual"       <?php echo selected( aicb_opt( 'chatbot_tone' ), 'casual', false ); ?>><?php esc_html_e( 'Casual (Warm, approachable, and conversational)', 'ai-chatbot' ); ?></option>
								<option value="professional" <?php echo selected( aicb_opt( 'chatbot_tone' ), 'professional', false ); ?>><?php esc_html_e( 'Professional (Polite, direct, and authoritative)', 'ai-chatbot' ); ?></option>
								<option value="minimalist"   <?php echo selected( aicb_opt( 'chatbot_tone' ), 'minimalist', false ); ?>><?php esc_html_e( 'Minimalist (Extremely brief, factual, and objective)', 'ai-chatbot' ); ?></option>
							</select>
						</td>
					</tr>
				</table>
			...
			<div class="aicb-section">
				...
				<table class="form-table">
					<tr>
						...
						<td>
							<label><input type="checkbox" name="aicb_enabled" value="1" <?php echo checked( aicb_opt( 'enabled' ), 1 ); ?> />
					...
					<tr>
						...
						<td>
							<label><input type="checkbox" name="aicb_show_on_all" value="1" <?php echo checked( aicb_opt( 'show_on_all' ), 1 ); ?> />
					...
					<tr>
						...
						<td>
							<select id="aicb_position" name="aicb_position">
								<option value="right"     <?php echo selected( aicb_opt( 'position' ), 'right', false ); ?>><?php esc_html_e( 'Bottom Right — floating button', 'ai-chatbot' ); ?></option>
								<option value="left"      <?php echo selected( aicb_opt( 'position' ), 'left', false ); ?>><?php esc_html_e( 'Bottom Left — floating button', 'ai-chatbot' ); ?></option>
								<option value="tab-right" <?php echo selected( aicb_opt( 'position' ), 'tab-right', false ); ?>><?php esc_html_e( 'Vertical Tab — Right edge', 'ai-chatbot' ); ?></option>
								<option value="tab-left"  <?php echo selected( aicb_opt( 'position' ), 'tab-left', false ); ?>><?php esc_html_e( 'Vertical Tab — Left edge', 'ai-chatbot' ); ?></option>
							</select>
						</td>
					</tr>
					<tr>
						<th><label for="aicb_primary_color"><?php esc_html_e( 'Primary Color', 'ai-chatbot' ); ?></label></th>
						<td><input type="color" id="aicb_primary_color" name="aicb_primary_color" value="<?php echo esc_attr( aicb_opt( 'primary_color' ) ); ?>" /></td>
					</tr>
					<tr>
						...
						<td>
							...
							foreach ( array(
								...
								<label style="margin-right:14px;cursor:pointer">
									<input type="radio" name="aicb_icon" value="<?php echo esc_attr( $k ); ?>" <?php echo checked( aicb_opt( 'icon' ), $k ); ?> style="display:none">
									<span style="font-size:26px" title="<?php echo esc_attr( $k ); ?>"><?php echo $e; ?></span>
								</label>
							<?php endforeach; ?>
						</td>
					</tr>
					<tr>
						...
						<td><input type="text" id="aicb_chat_title" name="aicb_chat_title" value="<?php echo esc_attr( aicb_opt( 'chat_title' ) ); ?>" class="regular-text" /></td>
					</tr>
					<tr>
						<th><label for="aicb_welcome_msg"><?php esc_html_e( 'Welcome Message', 'ai-chatbot' ); ?></label></th>
						<td><input type="text" id="aicb_welcome_msg" name="aicb_welcome_msg" value="<?php echo esc_attr( aicb_opt( 'welcome_msg' ) ); ?>" class="regular-text" /></td>
					</tr>
					<tr>
						<th><label for="aicb_placeholder"><?php esc_html_e( 'Input Placeholder', 'ai-chatbot' ); ?></label></th>
						<td><input type="text" id="aicb_placeholder" name="aicb_placeholder" value="<?php echo esc_attr( aicb_opt( 'placeholder' ) ); ?>" class="regular-text" /></td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" id="aicb_footer_text" name="aicb_footer_text" 
									value="<?php echo esc_attr( aicb_opt( 'footer_text' ) ); ?>" class="regular-text" />
			...
			<div class="aicb-section">
				...
				<table class="form-table">
					<tr>
						...
						<td>
							<label>
								<input type="checkbox" name="aicb_enable_feedback" value="1" <?php echo checked( aicb_opt( 'enable_feedback' ), 1 ); ?> />
					...
					<tr>
						...
						<td>
							...
							value="<?php echo esc_attr( aicb_opt( 'max_tokens' ) ); ?>"
					...
					<tr>
						...
						value="<?php echo esc_attr( aicb_opt( 'rate_limit' ) ); ?>"
					...
					<tr>
						...
						<td>
							...
							rows="5" class="large-text"><?php echo esc_textarea( aicb_opt( 'system_prompt' ) ); ?></textarea>
					...
					<tr>
						...
						<td>
							...
							value="<?php echo esc_attr( aicb_opt( 'log_retention_days' ) ); ?>"
			...
			<div class="aicb-section">
				...
				<table class="form-table">
					<tr>
						...
						<td>
							<label>
								<input type="checkbox" name="aicb_enable_handover" value="1" <?php echo checked( aicb_opt( 'enable_handover' ), 1 ); ?> />
					...
					<tr>
						...
						<td>
							<label>
								<input type="checkbox" id="aicb_show_footer_help_button" name="aicb_show_footer_help_button" value="1" <?php echo checked( aicb_opt( 'show_footer_help_button' ), 1 ); ?> />
					...
					<tr>
						...
						<td>
							<input type="text" id="aicb_handover_apology" name="aicb_handover_apology" 
									value="<?php echo esc_attr( aicb_opt( 'handover_apology' ) ); ?>" class="large-text" />
					...
					<tr>
						...
						<td>
							<input type="text" id="aicb_handover_prompt" name="aicb_handover_prompt" 
									value="<?php echo esc_attr( aicb_opt( 'handover_prompt' ) ); ?>" class="large-text" />
					...
					<tr>
						...
						<td>
							<textarea id="aicb_handover_trigger_phrases" name="aicb_handover_trigger_phrases" rows="6" class="large-text"><?php echo esc_textarea( aicb_opt( 'handover_trigger_phrases' ) ); ?></textarea>
					...
					<tr>
						...
						<td>
							<select id="aicb_handover_type" name="aicb_handover_type">
								<option value="whatsapp" <?php echo selected( aicb_opt( 'handover_type' ), 'whatsapp', false ); ?>><?php esc_html_e( 'WhatsApp', 'ai-chatbot' ); ?></option>
								<option value="tel"      <?php echo selected( aicb_opt( 'handover_type' ), 'tel', false ); ?>><?php esc_html_e( 'Phone Call', 'ai-chatbot' ); ?></option>
								<option value="sms"      <?php echo selected( aicb_opt( 'handover_type' ), 'sms', false ); ?>><?php esc_html_e( 'SMS Text', 'ai-chatbot' ); ?></option>
								<option value="custom"   <?php echo selected( aicb_opt( 'handover_type' ), 'custom', false ); ?>><?php esc_html_e( 'Custom Link', 'ai-chatbot' ); ?></option>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" id="aicb_handover_target" name="aicb_handover_target" 
									value="<?php echo esc_attr( aicb_opt( 'handover_target' ) ); ?>" class="regular-text" 
					...
					<tr>
						...
						<td>
							<input type="text" id="aicb_handover_btn_text" name="aicb_handover_btn_text" 
									value="<?php echo esc_attr( aicb_opt( 'handover_btn_text' ) ); ?>" class="regular-text" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" id="aicb_contact_btn_text" name="aicb_contact_btn_text" 
									value="<?php echo esc_attr( aicb_opt( 'contact_btn_text' ) ); ?>" class="regular-text" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="url" id="aicb_contact_btn_url" name="aicb_contact_btn_url" 
									value="<?php echo esc_url( aicb_opt( 'contact_btn_url' ) ); ?>" class="regular-text" 
						...
						<td>
							<fieldset style="display:flex;gap:20px;align-items:center">
								<label>
									...
									<input type="color" name="aicb_handover_primary_text" value="<?php echo esc_attr( aicb_opt( 'handover_primary_text' ) ); ?>" />
								</label>
								<label>
									<?php esc_html_e( 'Secondary BG', 'ai-chatbot' ); ?><br>
									<input type="color" name="aicb_handover_secondary_bg" value="<?php echo esc_attr( aicb_opt( 'handover_secondary_bg' ) ); ?>" />
								</label>
								<label>
									<?php esc_html_e( 'Secondary Text', 'ai-chatbot' ); ?><br>
									<input type="color" name="aicb_handover_secondary_text" value="<?php echo esc_attr( aicb_opt( 'handover_secondary_text' ) ); ?>" />
								</label>
								<label>
									<?php esc_html_e( 'Border Radius (px)', 'ai-chatbot' ); ?><br>
									<input type="number" name="aicb_handover_btn_radius" value="<?php echo esc_attr( aicb_opt( 'handover_btn_radius' ) ); ?>" min="0" max="50" class="small-text" />
								</label>
							</fieldset>
							<p style="margin-top:12px;">
								<label>
									<input type="checkbox" name="aicb_always_show_handover_buttons" value="1" <?php echo checked( aicb_opt( 'always_show_handover_buttons' ), 1 ); ?> />
									<strong><?php echo esc_html__( 'Always show buttons in chat window?', 'ai-chatbot' ); ?></strong> <?php echo esc_html__( '(Will display at the bottom of the chat window, below the message input box)', 'ai-chatbot' ); ?>
								</label>
							</p>
						</td>
					</tr>
			...
			<div class="aicb-section">
				...
				<table class="form-table">
					<tr>
						...
						<td>
							<label>
								<input type="checkbox" name="aicb_enable_lead_capture" value="1" <?php echo checked( aicb_opt( 'enable_lead_capture' ), 1 ); ?> />
					...
					<tr>
						...
						<td>
							<input type="email" id="aicb_lead_notification_email" name="aicb_lead_notification_email"
									value="<?php echo esc_attr( aicb_opt( 'lead_notification_email' ) ); ?>" class="regular-text"
					...
					<tr>
						...
						<td>
							<label>
								<input type="checkbox" name="aicb_enable_transcript_export" value="1" <?php echo checked( aicb_opt( 'enable_transcript_export' ), 1 ); ?> />
			...
			<div id="aicb-advanced-prompts-panel" class="aicb-section">
				...
				<table class="form-table">
					<tr>
						...
						<td>
							<textarea id="prompt_temporal_pivot" name="aicb_prompt_temporal_pivot" rows="3" class="large-text" required><?php echo esc_textarea( aicb_opt( 'prompt_temporal_pivot' ) ); ?></textarea>
					...
					<tr>
						...
						<td>
							<textarea id="prompt_tool_instruction" name="aicb_prompt_tool_instruction" rows="8" class="large-text" required><?php echo esc_textarea( aicb_opt( 'prompt_tool_instruction' ) ); ?></textarea>
					...
					<tr>
						...
						<td>
							<textarea id="prompt_negative_constraints" name="aicb_prompt_negative_constraints" rows="10" class="large-text" required><?php echo esc_textarea( aicb_opt( 'prompt_negative_constraints' ) ); ?></textarea>
...
<script>
(function() {
	var catalog  = <?php echo wp_json_encode( aicb_get_catalog() ); ?>;
	var curModel = <?php echo wp_json_encode( $cur_model ); ?>;
	var providerMap = {};
	...
	updateModels(<?php echo wp_json_encode( $cur_provider ); ?>);
	updateDesc();
